    ...
    <div className="min-h-screen bg-[#0a0a0b] relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        <div className="max-w-2xl w-full text-center animate-fadeIn">
          ...
          {/* Title */}
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent leading-tight">
            Pokemon TCG
            <br />
            Deck Tracker
          </h1>
          ...
          <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-xl mx-auto">
            Import your decks, track your wins and losses, analyze matchups, and improve your game
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="glass rounded-xl p-6">
              ...
              <h3 className="text-base font-semibold mb-2">Import Decks</h3>
              <p className="text-sm text-gray-500">Paste PTCGL deck lists directly</p>
            </div>
            ...
            <div className="glass rounded-xl p-6">
              ...
              <h3 className="text-base font-semibold mb-2">Track Stats</h3>
              <p className="text-sm text-gray-500">Detailed win/loss analytics</p>
            </div>
            ...
            <div className="glass rounded-xl p-6">
              ...
              <h3 className="text-base font-semibold mb-2">Analyze Matchups</h3>
              <p className="text-sm text-gray-500">See performance vs specific decks</p>
            </div>
          </div>
          ...
          <Button
            ...
            onClick={handleLogin}
            size="lg"
            className="bg-white text-black hover:bg-gray-100 text-lg px-8 py-6 rounded-xl font-semibold shadow-lg shadow-white/10 transition-all hover:shadow-white/20 hover:scale-105"
          >
